...
data_num4 = 9
data_num3 = 12
data_num2 = 2 * data_num4
data_num1 = 4 * data_num4
method = 'LLR-BP'
...
#                                    SNR=SNR_list1)
BER1, SNR1 = my_link.simulate_BER(encode_method, decode_method, data_num=1, is_save=False, imagID=1,
                                   save_dir='/Users/mac/Desktop/LDPC-star/imag',
                                   SNR=SNR_list1)
print(f'BER:{BER1}')
ebn0_data.append(deepcopy(SNR1))
BER1 = [[0.48, 0.17, 0.082, 0.04, 0.0052, 0.0011, 0., 0., 0., 0., 0., 0.]]
print(SNR1)
print(f'BER:{BER1}')
...
# 仿真
BER2, SNR2 =  my_link.simulate_BER(encode_method, decode_method, data_num=1, is_save=False, imagID=1,
                                   save_dir='/Users/mac/Desktop/LDPC-star/imag',
                                   SNR=SNR_list2)
print(f'BER:{BER2}')
ebn0_data.append(deepcopy(SNR2))
BER2 = [[0.53, 0.36, 0.093, 0.033, 0.0026, 0., 0., 0., 0., 0., 0., 0.]]
print(SNR2)
print(f'BER:{BER2}')
...
# 仿真
BER3, SNR3 = my_link.simulate_BER(encode_method, decode_method, data_num=data_num3, is_save=False, imagID=1,
                                   save_dir='/Users/mac/Desktop/LDPC-star/imag',
                                   SNR=SNR_list3)
print(SNR3)
...
plot_ber_vs_ebn0(ber_data, ebn0_data, rate_labels, save_path='码长实验2（LLR）.png')
